...
import {InstancedGrassyField} from '../obj/InstancedGrassyField.js';
...
export default class InstancedHillApp extends QuentinLike {
  constructor(params) {
    super(params);
    this.id = params.id;
  ...
  addGrassyField() {
    console.log("Meow!");
    this.field = new InstancedGrassyField(
        30,
        30,
        9.0,
        30,
